...
(function ($, window) {
    ...
    functionality.template = [
        '<div class="city-pavilion hide">',
            '<div class="city-tabs">',
                '<a href="javascript:;" class="tab-a active" data-letter="HOT">选项</a>',
    ...
    functionality.showDrop = function (event) {
        ...
        self.$selector.addClass('down').find('.city-pavilion').toggleClass('hide').siblings('.city-list').toggleClass('hide');
    ...
    functionality.singleAchieve = function (event) {
        ...
        this.$selector.find('.city-input').before('<span data-id="' + id + '" data-parentid="' + parentId + '">' + name + '</span>').find('.input-search').val(name);//<i class="del"></i>
